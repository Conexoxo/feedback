class ApplicationController < ActionController::Base
	...
	def configure_devise_params
		devise_parameter_sanitizer.permit(:sign_up) do |profesor|
			profesor.permit(:nombre,:email,:rut,:apellido_paterno, :apellido_materno, :password, :password_confirmation)
		end
	end
	def configure_devise_params
